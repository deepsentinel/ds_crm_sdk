...
class CRMClient:
    ...
    def get_accounts_by_filters(self, filters: dict, page=1, page_size=10):
        """
    ...
    def get_account_addresses(self, account_id: str, page=1, page_size=10):
        """
    ...
    def get_account_addresses_by_filters(self, account_id: str, filters: dict, page=1, page_size=10):
        """
    ...
    def get_account_types(self, page=1, page_size=10):
        """
