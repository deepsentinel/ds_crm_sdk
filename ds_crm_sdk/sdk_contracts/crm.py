...
class CRMClientAPI(ABC):
    ...
    def get_accounts(self, filters: dict = None, offset=0, limit=10,
                     sort_by: str = 'created', sort_order: str = 'DESC') -> tuple:
        """
    ...
    def create_account(self, account_data: AccountRequestDTO) -> tuple:
        ...
        :param account_data: A dictionary containing the account data to create.
        :return: Created account details with http status code.
        """
        ...
